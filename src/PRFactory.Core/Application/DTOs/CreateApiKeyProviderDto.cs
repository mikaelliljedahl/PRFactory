...
/// <summary>
/// DTO for creating an API key-based LLM provider
/// </summary>
public class CreateApiKeyProviderDto
{
    /// <summary>
    ...
    /// <summary>
    /// Provider type identifier (ZAi, MinimaxM2, OpenRouter, TogetherAI, Custom)
    /// </summary>
    ...
    /// <summary>
    /// Timeout in milliseconds for API requests (default: 300000 = 5 minutes)
    /// </summary>
