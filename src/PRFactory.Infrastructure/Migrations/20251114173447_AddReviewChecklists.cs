...
{
    /// <inheritdoc />
    public partial class AddReviewChecklists : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "InlineCommentAnchors",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ReviewCommentId = table.Column<Guid>(type: "TEXT", nullable: false),
                    StartLine = table.Column<int>(type: "INTEGER", nullable: false),
                    EndLine = table.Column<int>(type: "INTEGER", nullable: false),
                    TextSnippet = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ReviewCommentId1 = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InlineCommentAnchors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InlineCommentAnchors_ReviewComments_ReviewCommentId",
                        column: x => x.ReviewCommentId,
                        principalTable: "ReviewComments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InlineCommentAnchors_ReviewComments_ReviewCommentId1",
                        column: x => x.ReviewCommentId1,
                        principalTable: "ReviewComments",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    PlanReviewId = table.Column<Guid>(type: "TEXT", nullable: false),
                    TemplateName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewChecklists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReviewChecklists_PlanReviews_PlanReviewId",
                        column: x => x.PlanReviewId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ReviewChecklistId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChecklistItems_ReviewChecklists_ReviewChecklistId",
                        column: x => x.ReviewChecklistId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChecklistItems_ReviewChecklistId",
                table: "ChecklistItems",
                column: "ReviewChecklistId");

            migrationBuilder.CreateIndex(
                name: "IX_ChecklistItems_ReviewChecklistId_SortOrder",
                table: "ChecklistItems",
                columns: new[] { "ReviewChecklistId", "SortOrder" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InlineCommentAnchors_LineRange",
                table: "InlineCommentAnchors",
                columns: new[] { "StartLine", "EndLine" });

            migrationBuilder.CreateIndex(
                name: "IX_InlineCommentAnchors_ReviewCommentId",
                table: "InlineCommentAnchors",
                column: "ReviewCommentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InlineCommentAnchors_ReviewCommentId1",
                table: "InlineCommentAnchors",
                column: "ReviewCommentId1",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ReviewChecklists_PlanReviewId",
