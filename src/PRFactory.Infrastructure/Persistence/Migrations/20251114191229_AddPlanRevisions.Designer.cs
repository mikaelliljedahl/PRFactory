...
namespace PRFactory.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251114191229_AddPlanRevisions")]
    partial class AddPlanRevisions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRFactory.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PRFactory.Domain.Entities.PlanRevision", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("TicketId", "RevisionNumber")
                        .HasDatabaseName("IX_PlanRevisions_TicketId_RevisionNumber");

                    b.ToTable("PlanRevisions", (string)null);
                });
            ...
            modelBuilder.Entity("PRFactory.Domain.Entities.Notification", b =>
                {
                    ...
                    b.HasOne("PRFactory.Domain.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PRFactory.Domain.Entities.PlanRevision", b =>
                {
                    b.HasOne("PRFactory.Domain.Entities.User", "CreatedBy")
                        .WithMany()
