...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRFactory.Domain.Entities.Plan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PRFactory.Domain.Entities.PlanVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PRFactory.Domain.Entities.Plan", b =>
                {
                    b.HasOne("PRFactory.Domain.Entities.Ticket", "Ticket")
                        .WithOne()
                        .HasForeignKey("PRFactory.Domain.Entities.Plan", "TicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PRFactory.Domain.Entities.PlanVersion", b =>
                {
                    b.HasOne("PRFactory.Domain.Entities.Plan", "Plan")
                        .WithMany("Versions")
