...
/// <summary>
/// Base class for prompt template form models (Create and Update requests).
/// Contains common properties used by the PromptTemplateForm component.
/// </summary>
public abstract class PromptTemplateFormModel
{
    /// <summary>
